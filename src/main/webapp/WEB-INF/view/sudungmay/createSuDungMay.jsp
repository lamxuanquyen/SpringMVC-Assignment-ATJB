	...
	<div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <jsp:include page="/WEB-INF/view/sudungmay/form_create_sudungmay.jsp" />
...
<script type="text/javascript"	src="<c:url value='/resources/js/validate/create_su_dung_may.js' />"></script>

...
<div class="container bg-light mt-5">
    <div class="row mt-3">
        <div class="col-lg-12 text-center">
            <h2 class="mt-3">CREATE NEW MAY</h2>
        </div>
        <div class="col-lg">
            <form:form id ="form_create_May" method="post" action="${contextPath}/may/create"  modelAttribute="may">
			    ...
			    <div class="form-group mt-5">
			        ...
			        <a class="btn btn-danger ml-3" type="text" href="${contextPath}/may/list" >Hủy bỏ</a>				 
			    </div>

	...
	<div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <jsp:include page="/WEB-INF/view/khachhang/form_create_khachhang.jsp" />
...
<%-- <script type="text/javascript"	src="<c:url value='/resources/js/validate/create_khach_hang.js' />"></script> --%>
</body>
